<?php
    ...
    /*
        ...
        === eRequest ===
        Developed by Charlie Maddex
        .NET/PHP library to allow encrypted json data to be transferred between client and server.
        Github: https://github.com/name/eRequest
        LICENSE: https://github.com/name/eRequest/blob/master/LICENSE.md
    ...
    */
    ...
    class eRequest {
        ...
        // Decrypts POST data from eRequest client.
        ...
        // Returns encrypted JSON information to eRequest client.
    ...
    /* Encryption class to safely communicate with eRequest client.
       Example:
